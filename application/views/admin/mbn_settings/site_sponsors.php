...
.table td img {
 ...
 <?php $widgets = $this->db->order_by("b_id", "desc")->get_where('home_blocks',array('post_type'=>'sponsors'))->result();?>
                ...
                <div class="row">
                 <?php if($sucesess = $this->session->flashdata('sucesess')): ?>
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        ...
                        <div class="card">
                          <div class="card-body">
                            <h4 class="mb-15">Site Sponsors <a href="<?php echo base_url('mbncms/add_edit_site_sponsers') ?>" class="btn btn-primary"> Add New Site Sponsors</a></h4>
                                ...
                                <tbody>
                                  <?php foreach($widgets as $page): ?>
                                      <tr>
                                        ...
                                        <td><a style="margin-top:10px" class="btn btn-sm btn-primary" href="<?php echo base_url('mbncms/add_edit_site_sponsers/') .$page->b_id?>">Edit</a>
