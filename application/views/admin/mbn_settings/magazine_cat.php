                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <?php $categories =  $this->db->get('magazine_cat')->result() ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="post" action="<?php echo base_url('mbncms/magazine_cat') ?>">
        ...
        <div class="modal fade" id="confirm-delete_<?php echo $cat->categoryID ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <a href="<?php echo base_url('mbncms/delete_magazine_cat/'.$cat->categoryID) ?>" style="color:#fff" class="btn btn-danger btn-ok">Delete</a>
                    </div>
                </div>
            </div>
        </div>
