...
<!-- partial:partials/_navbar.html -->
	...
	<!-- core:js -->
	<script type="text/javascript" src="<?php echo base_url('assets/vendors/core/core.js') ?>"></script>
	<!-- endinject -->
  <!-- plugin js for this page -->
	...
	<script type="text/javascript" src="<?php echo base_url('assets/vendors/feather-icons/feather.min.js') ?>"></script>
