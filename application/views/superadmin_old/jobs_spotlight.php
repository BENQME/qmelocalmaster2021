...
<body>
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
          ...
          <div>
			<h4 class="mb-3 mb-md-0">Product Manager (Multiple opportunities)</h4>
		...
		<div class="row">
				<div class="col-md-8">
							...
							<p>We are looking for real estate agents for real estate business, who have previous experience and good knowledge in property dealing and sales in Islamabad/Rawalpindi Surrounding area... Promote and capture sales through advertising on social, ad posting platforms and develop networks within other real estate agents, investors and clients.							</p>	
							<br />
							<h6 class="card-title">Requirements</h6>
							
								<P>Proven working experience as a real estate salesperson specifically in Islamabad/Rawalpindi Surrounding area.</P>
								<P>Punctual, Honest, professional, pleasant personality.</P>
								<P>Good command on MS Office, OLX, Zameen and other Social Media Portals.</P>
								<P>Must have convence.</P>

								<br />
								<h6 class="card-title">Benefits</h6>		

								<p>Salary Package: 15k to 50k basic salary as per experience.</p>	
								<p>Great Commission</p>	
								<p>Daily Lunch </p>	
								<p>Sick, casual and annual leaves.</p>	
								<p>Training sessions by professional experts. </p>	
								<p>Fuel Allowance</p>	
								<p>Sim</p>	
								...
								<div class="col-md-6 grid-margin">
													<div class="card rounded">
														...
														<div class="card-body">
															...
															<div class="pull-left">	
															<h6 class="date_time">Salary <br /> <span>$60,000</span></h6>		
															</div>
															<div class="pull-right">
																<h6 class="date_time">Position <br /> <span>UX Designer</span></h6>
															</div>
