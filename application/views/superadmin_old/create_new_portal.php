...
<body>
	<div class="main-wrapper">
		...
		<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">New Portal</h4>
          </div>
					  ...
					  <div class="row">
						<div class="col-sm-6">
						  <div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter Portal Title">
						  </div>
						</div><!-- Col -->
						<div class="col-sm-6">
						  <div class="form-group">
					  ...
					  <div class="row">
						...
						<div class="col-sm-4">
						  <div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter Username of the portal">
						  </div>
						</div><!-- Col -->
						<div class="col-sm-4">
						  <div class="form-group">
		...
		<!-- <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
			<div>
			  <h4 class="mb-3 mb-md-0">Invite first user of this portal</h4>
			</div>
			<div class="d-flex align-items-center flex-wrap text-nowrap">
		...
		<div class="row">
			<div class="col-md-12 stretch-card">
			  <div class="card">
				<div class="card-body">
					<h4 class="card-title">Invite first user of this portal</h4>
					<form>
					  <div class="row">
						<div class="col-sm-6">
						  <div class="form-group">
					...
					<button type="button" class="btn btn-primary submit">INVITE</button>
				</div>
			  </div>
			</div>
			...
			<div class="col-md-12 stretch-card">
			  <div class="card">
				<div class="card-body">
					...
					<button type="button" class="btn btn-success submit">Yes, Do it.</button>

					<button type="button" class="btn btn-danger submit">No, Not at the moment </button>
				</div>
			  </div>
			</div>
