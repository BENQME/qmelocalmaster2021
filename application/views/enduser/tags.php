<div class="page-content">
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0"><?php echo $_GET['tag']?></h4>
        </div>
    </div>
<div class="row set-card-spacing">
	<?php 
	//print_r($spotlight_all); 
					 ...
					 <div class="d-flex align-items-center justify-content-between">
						 ...
						 <div class="dropdown">
							 ...
							 <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
							 	 <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('dashboard/create_new_spotlight/'.$spotlight['postID']);?>"><i data-feather="copy" class="icon-sm mr-2"></i> <span class="">Edit</span></a>
							 	 <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('dashboard/delete_spotlight/'.$spotlight['postID']);?>"><i data-feather="copy" class="icon-sm mr-2"></i> <span class="">Delete</span></a>
