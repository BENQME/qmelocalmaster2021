	 ...
	 <div class="container">
		<div class="row activities-content">
		   <div class="col-sm-12">
			  ...
			  <h1 class="wow fadeInDown" data-wow-delay="0.1s">Search Result for "<?php echo $_GET['search'] ?>"</h1>
		   </div>
		...
		<div class="row flexx_boxx">
          ...
          <?php else: ?>
					<a href="<?php echo base_url('detail/'.$spotlight['postSlug']) ?>" class="" > <?php if(!empty($spotlight['cover_photo'])):?>
                ...
                <?php endif;?> 
					 <div class="caption">
						<h5><?php echo $spotlight['category'] ?></h5>
