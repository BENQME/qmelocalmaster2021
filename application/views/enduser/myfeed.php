<div class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
          <h4 class="mb-3 mb-md-0"><i class="link-icon" data-feather="feather"></i>  My Feed <span class="edit_my_pr"><a href="<?php echo base_url('dashboard/preference') ?>">Edit Your Preference</a></span></h4>
        </div>
...
<?php if(!empty($this->input->get('search'))) $s_query = '?search='.$this->input->get('search');else $s_query =""; ?>
    ...
    <ul class="nav nav-tabs " role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link<?php if(isset($current) && $current =='media') echo ' active' ?>"  href="<?php echo base_url('dashboard/myfeed/media'.$s_query) ?>" role="tab">Media/Podcast <span class="badge badge-primary"><?php echo str_pad($media_total, 2, '0', STR_PAD_LEFT); ?></span></a>
        </li>
    </ul><!-- Tab panes -->
