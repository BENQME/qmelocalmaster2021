			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 pl-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="forms-sample" id="register" method="post" action="<?php echo base_url('enduser/register/validate');?>">
                      ...
                      <a href="<?php echo base_url('enduser/login') ?>" class="d-block mt-3 ">Already a user? Sign in</a>
                    </form>
                  </div>
                </div>
              </div>
