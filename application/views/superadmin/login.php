...
<div class="page-content register-form">
    ...
    <h4 class="text-center"><?php echo site_info() ?> Login</h4><br />
    <div class="row w-100 mx-0 auth-page">
      ...
      <div class="auth-form-wrapper px-4 py-4">
        ...
        <?php endif ?>
        <form class="forms-sample" id="login" method="post" action="<?php echo base_url('superadmin'); ?>">
          ...
          <div class="d-flex justify-content-between">
            ...
            <p class="mt-10">
              <span class="text-right"><a href="<?php echo base_url().'superadmin/reset_password' ?>">Forgot Password?</a></span> 
            </p>
