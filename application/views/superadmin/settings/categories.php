                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <?php $categories =  $this->db->get('spotlights_category')->result() ?>
        ...
        <div class="modal fade" id="confirm-delete_<?php echo $cat->categoryID ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <a href="<?php echo base_url('settings/delete_category/'.$cat->categoryID) ?>" style="color:#fff" class="btn btn-danger btn-ok">Delete</a>
                    </div>
                </div>
            </div>
        </div>
