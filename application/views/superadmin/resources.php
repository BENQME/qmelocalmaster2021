...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
		...
		if($user_level ==3){		
		?>
        <a href="<?php echo base_url('superadmin/add_resources') ?>" class="btn btn-primary"> Add New Service</a>
        <?php } ?>
        </h4>
    </div>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                          ...
                          <div class="clearfix">
                              	...
                              	<a class="btn btn-success btn-sm" href="<?php echo base_url('superadmin/add_resources/'.$rs->id) ?>">Edit</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?php echo base_url('superadmin/delete_resources/'.$rs->id) ?>" style="color:#fff" class="btn btn-danger btn-ok">Delete</a>
                    </div>
                </div>
            </div>
        </div>
