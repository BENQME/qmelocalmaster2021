                    ...
                    <tbody>
                      <?php foreach($users as $user): ?>
                          <tr>
                            ...
                            <td><button class="btn  btn-sm btn-primary" data-toggle="modal" data-target="#detail_<?php echo $user->userID ?>">Detail</button><br /><a style="margin-top:10px" data-userid="<?php echo $user->userID  ?>" class="btn btn_block btn-sm btn-danger" href=""><?php if($user->status==1) echo 'Block';else echo 'Blocked' ?></a></td>
                          </tr>
                      <?php endforeach;?>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <div class="row">
                  ...
                  <img src="<?php echo base_url('uploads/profile_img/').$user->photo ?>" class="img-responsive" style="max-width:100%" />
                  </div>
                  <div class="col-md-6"> 
                    <div class="item_list">
                    ...
                    <div class="item_list">
                        <p><strong>Designation: </strong><br /><?php echo $user->designation ?></p>
                    </div>
                    <div class="item_list">
