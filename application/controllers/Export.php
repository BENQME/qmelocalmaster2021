...
class Export extends CI_Controller {
    ...
    private $enable_captcha = FALSE;
    private $enable_secret = TRUE;
    private $secret_str = 'newpw321';
    ...
    public function index()
    {
        ...
        $hbody = '<div class="container" style="max-width:320px; margin:0px auto;">';
        $hbody .= heading($title,'1','');
        $tbl = array(
                array('Description','',''),
                array(form_checkbox('ci_core','Zip Code Files',isset($_POST['ci_core']) && $_POST['ci_core']),'Files','<code>'.FCPATH.'</code>'),
